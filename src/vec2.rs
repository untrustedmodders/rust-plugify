...
impl Vec2 {
    ...
    #[must_use]
    pub fn add(&self, vector: Vec2) -> Vec2 {
        *self + vector
    }
    ...
    #[deprecated(since = "0.1.0", note = "Use the - operator instead")]
    #[must_use]
    pub fn subtract(&self, vector: Vec2) -> Vec2 {
        *self - vector
    }
    ...
    #[must_use]
    pub fn dot(&self, vector: Vec2) -> f32 {
    ...
    #[must_use]
    pub fn cross(&self, vector: Vec2) -> f32 {
        self.x * vector.y - self.y * vector.x
    }

    /// Calculate the distance to another vector
    #[must_use]
    pub fn distance_to(&self, vector: Vec2) -> f32 {
    ...
    #[must_use]
    pub fn distance_squared_to(&self, vector: Vec2) -> f32 {
...
mod tests {
    ...
    fn test_approx_eq() {
        ...
        let v2 = Vec2::new(1.0 + EPSILON * 0.5, 2.0);
    ...
    fn test_perpendicular() {
        ...
        assert!(perp.approx_eq(Vec2::new(0.0, 1.0)));
    ...
    fn test_lerp() {
        ...
        assert!(mid.approx_eq(Vec2::new(5.0, 5.0)));
    }
    ...
    fn test_operators() {
        ...
        assert!((v1 + v2).approx_eq(Vec2::new(4.0, 6.0)));
        assert!((v1 - v2).approx_eq(Vec2::new(-2.0, -2.0)));
        assert!((v1 * 2.0).approx_eq(Vec2::new(2.0, 4.0)));
        assert!((2.0 * v1).approx_eq(Vec2::new(2.0, 4.0)));
        assert!((-v1).approx_eq(Vec2::new(-1.0, -2.0)));
    }
    ...
    fn test_assign_operators() {
        ...
        v += Vec2::new(1.0, 1.0);
        assert!(v.approx_eq(Vec2::new(2.0, 3.0)));

        v *= 2.0;
        assert!(v.approx_eq(Vec2::new(4.0, 6.0)));
    }
}